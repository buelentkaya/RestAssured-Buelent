...
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void oneSpartanPojo(){
        ...
        System.out.println(spartan15);   //Spartan{id=15, name='Meta', gender='Female', phone=1938695106}
        System.out.println("spartan15.getId() = " + spartan15.getId());   //spartan15.getId() = 15
        System.out.println("spartan15.getGender() = " + spartan15.getGender());  //spartan15.getGender() = Female
    ...
    public void test4(){
        ...
        System.out.println("spartanList.get(1).getName() = " + spartanList.get(1).getName());//spartanList.get(1).getName() = Wash
    }
